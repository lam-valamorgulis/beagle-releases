...
## Latest: v0.2.0-beta.1 (2026-05-07)

| Platform | Download |
|----------|----------|
| macOS Apple Silicon (M1 / M2 / M3) | [Beagle-0.2.0-beta.1-arm64.dmg](https://github.com/lam-valamorgulis/beagle-releases/releases/download/v0.2.0-beta.1/Beagle-0.2.0-beta.1-arm64.dmg) |
| macOS Intel | [Beagle-0.2.0-beta.1.dmg](https://github.com/lam-valamorgulis/beagle-releases/releases/download/v0.2.0-beta.1/Beagle-0.2.0-beta.1.dmg) |
| Windows x64 | [Beagle.Setup.0.2.0-beta.1.exe](https://github.com/lam-valamorgulis/beagle-releases/releases/download/v0.2.0-beta.1/Beagle.Setup.0.2.0-beta.1.exe) |
