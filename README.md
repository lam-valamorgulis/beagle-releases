...
| Platform | Download |
|----------|----------|
| macOS Apple Silicon (M1 / M2 / M3) | [Beagle-0.1.0-arm64.dmg](https://github.com/lam-valamorgulis/beagle-releases/releases/download/v0.1.0/Beagle-0.1.0-arm64.dmg) |
| macOS Intel | [Beagle-0.1.0.dmg](https://github.com/lam-valamorgulis/beagle-releases/releases/download/v0.1.0/Beagle-0.1.0.dmg) |
| Windows x64 | [Beagle.Setup.0.1.0.exe](https://github.com/lam-valamorgulis/beagle-releases/releases/download/v0.1.0/Beagle.Setup.0.1.0.exe) |
